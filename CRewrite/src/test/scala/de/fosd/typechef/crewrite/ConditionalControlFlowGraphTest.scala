...
class ConditionalControlFlowGraphTest extends FunSuite with TestHelper with ShouldMatchers with VariablesImpl with ConditionalControlFlowImpl with LivenessImpl{
