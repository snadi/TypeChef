...
//    println("AST: " + c)
//    println(PrettyPrinter.print(c.value))
//    print("e1"); e1->isPartOfIEEChain should be(false)
//    print("e2"); e2->isPartOfIEEChain should be(true)
//    print("e3"); e3->isPartOfIEEChain should be(true)
//    print("e4"); e4->isPartOfIEEChain should be(false)
//    print("e5"); e5->isPartOfIEEChain should be(false)
//    print("e6"); e6->isPartOfIEEChain should be(false)
//    print("e7"); e7->isPartOfIEEChain should be(false)
//  }
//
...
////    print("e4"); e4->isPartOfIEEChain should be(false)
////    print("e5"); e5->isPartOfIEEChain should be(false)
////    print("e6"); e6->isPartOfIEEChain should be(true)
////    print("e7"); e7->isPartOfIEEChain should be(true)
//  }
  ...
  test("conditional labelstatements isPartOfIEEChain3") {
    ...
    println("AST: " + c)
    println(PrettyPrinter.print(c.value))
    print("e1"); e1->isPartOfIEEChain2 should be(false)
    print("e2"); e2->isPartOfIEEChain2 should be(true)
    print("e3"); e3->isPartOfIEEChain2 should be(true)
    print("e4"); e4->isPartOfIEEChain2 should be(false)
    print("e5"); e5->isPartOfIEEChain2 should be(false)
    print("e6"); e6->isPartOfIEEChain2 should be(true)
    print("e7"); e7->isPartOfIEEChain2 should be(true)
  }
  ...
  test("conditional labelstatements isPartOfIEEChain4") {
    ...
    print("e2"); e2->isPartOfIEEChain2 should be(true)
    print("e3"); e3->isPartOfIEEChain2 should be(true)
    print("e4"); e4->isPartOfIEEChain2 should be(true)
    print("e5"); e5->isPartOfIEEChain2 should be(true)
    print("e6"); e6->isPartOfIEEChain2 should be(true)
    print("e7"); e7->isPartOfIEEChain2 should be(false)
  }
